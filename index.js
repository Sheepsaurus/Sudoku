...
function GeneratePuzzle (rowGrid) {    
    var repeats = 100;
    for (var x = 0; x < repeats; x++) SwapRandomNumberPairs(rowGrid);
    for (var x = 0; x < repeats; x++) SwapRandomVerticalLines(rowGrid);
    for (var x = 0; x < repeats; x++) SwapRandomVerticalSections(rowGrid); 
    for (var x = 0; x < repeats; x++) SwapRandomHorizontalLines(rowGrid); 
    for (var x = 0; x < repeats; x++) SwapRandomHorizontalSections(rowGrid); 
}

function SwapRandomHorizontalSections(rowGrid) {    
...
function SwapRandomHorizontalLines(rowGrid) { 
    var random = Math.floor((Math.random() * 3) + 1);
    var s1 = Math.floor((Math.random() * 3) + 1);
    var s2 = s1 == 1 ? (random == 0 ? 2 : 3) : s1 == 2 ? (random == 0 ? 1 : 3) : (random == 0 ? 1 : 2);    
    var tmpBoard = copyBoard(rowGrid);
...
function SwapRandomVerticalSections(rowGrid) {       
    var random = Math.floor((Math.random() * 3) + 1);
    var s1 = Math.floor((Math.random() * 3) + 1);
    var s2 = s1 == 1 ? (random == 0 ? 2 : 3) : s1 == 2 ? (random == 0 ? 1 : 3) : (random == 0 ? 1 : 2);    
    var tmpBoard = copyBoard(rowGrid);
...
function SwapRandomVerticalLines(rowGrid) {
    var random = Math.floor((Math.random() * 3) + 1);
    var s1 = Math.floor((Math.random() * 3) + 1);
    var s2 = s1 == 1 ? (random == 0 ? 2 : 3) : s1 == 2 ? (random == 0 ? 1 : 3) : (random == 0 ? 1 : 2);
    var tmpBoard = copyBoard(rowGrid);
...
function SwapRandomNumberPairs(rowGrid) {
    for (var _ = 0; _ < 48; _++) {
